...
class SCCMOperationsCMD(CommandSet):
    ...
    get_operation_status_parser.add_argument('-oi', '--operationID', action = 'store', type = int, required = True, help = 'ID of the operation')
    ...
    def get_operation_status(self, ns: argparse.Namespace):
        print_data(self.operations.get_operation_status(ns.operationID, ns.property))
